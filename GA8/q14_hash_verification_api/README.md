...
This README summarizes the question folder. The detailed solution remains in `q14_hash_verification_api.md`.
...
| `q14_hash_verification_api.md` | Detailed question writeup |
