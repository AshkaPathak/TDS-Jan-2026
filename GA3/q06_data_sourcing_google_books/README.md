...
This README summarizes the question folder. The detailed solution remains in `q06_data_sourcing_google_books.md`.
...
| File | Purpose |
| --- | --- |
| `q06_data_sourcing_google_books.md` | Detailed question writeup |
