...
This README summarizes the question folder. The detailed solution remains in `q01_excel_operational_margin_consolidation.md`.
...
| File | Purpose |
| --- | --- |
| `q01_excel_operational_margin_consolidation.md` | Detailed question writeup |
