...
This README summarizes the question folder. The detailed solution remains in `q05_data_contract_violation_detector.md`.
...
| File | Purpose |
| --- | --- |
| `q05_data_contract_violation_detector.md` | Detailed question writeup |
