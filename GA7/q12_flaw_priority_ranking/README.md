...
This README summarizes the question folder. The detailed solution remains in `q12_flaw_priority_ranking.md`.
...
| File | Purpose |
| --- | --- |
| `q-flaw-priority-ranking.xlsx` | data artifacts |
| `q12_flaw_priority_ranking.md` | Detailed question writeup |
