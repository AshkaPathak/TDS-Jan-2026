...
This README summarizes the question folder. The detailed solution remains in `q07_headline_rewriting.md`.
...
| File | Purpose |
| --- | --- |
| `q07_headline_rewriting.md` | Detailed question writeup |
