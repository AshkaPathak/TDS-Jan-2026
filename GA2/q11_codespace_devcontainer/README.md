...
This README summarizes the question folder. The detailed solution remains in `q11_codespace_devcontainer.md`.
...
| File | Purpose |
| --- | --- |
| `q11_codespace_devcontainer.md` | Detailed question writeup |
