...
This README summarizes the question folder. The detailed solution remains in `q12_duckdb_revenue_growth.md`.

## Method

Solved with SQL-style transformations, aggregation, joins, filtering, and a final query/result check.
...
| File | Purpose |
| --- | --- |
| `q12_duckdb_revenue_growth.md` | Detailed question writeup |
